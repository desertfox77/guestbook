      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add New Private Class</h1>
            </div>
            
            <div class="row">
          <div class="col-lg-6">
              <form action="<?= base_url('Partner/apriva')?>" method="post">
              <?= $this->session->flashdata('message'); ?>
              <div class="form-group">
    <label for="class_name" >Class Name</label>
      <input type="label" class="form-control" id="class_name" name="class_name">
...
<br>
    ...
    <label for="class_price" >Class Price</label>
      <input type="number" class="form-control" id="class_price" name="class_price">
