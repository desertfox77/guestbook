...
<style>.bootstrap-iso .formden_header h2, .bootstrap-iso .formden_header p, .bootstrap-iso form{font-family: Arial, Helvetica, sans-serif; color: black}.bootstrap-iso form button, .bootstrap-iso form button:hover{color: white !important;} .asteriskField{color: red;}</style>
  ...
  <div id="wrapper">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <div class="row">
          <div class="col-lg-6">
              <form action="<?= base_url('Partner/atrain')?>" method="post">
              <?= $this->session->flashdata('message'); ?>
              <div class="form-group">
                  
    <label for="trainer_name" >Trainer Name</label>
      <input type="label" class="form-control" id="trainer_name" name="trainer_name">
      <?= form_error('trainer_name', '<small class="text-danger pl-3">', '</small>'); ?>
    </div>
    <div class="form-group">
    <label for="trainer_price" >Trainer Price</label>
      <input type="label" class="form-control" id="trainer_price" name="trainer_price">
    ...
    <br>
    <div class="form-group">
        <button type="submit" class="btn btn-primary">Add new Trainer</button>
    </div>
