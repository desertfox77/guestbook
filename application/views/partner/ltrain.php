...
<style>.bootstrap-iso .formden_header h2, .bootstrap-iso .formden_header p, .bootstrap-iso form{font-family: Arial, Helvetica, sans-serif; color: black}.bootstrap-iso form button, .bootstrap-iso form button:hover{color: white !important;} .asteriskField{color: red;}</style>
  ...
  foreach ($hasil->result_array() as $row) :  ?>
    <tr>
      <th scope="row"><?=$a++?></th>
     <td><img src="<?= base_url('assets/img/') . $row['image']?>"  width="50" height="50"></td> 
      <td><?=$row ['name']; ?></td>
      <td><?=$row ['price']; ?></td>
      ...
      <td><?=$row ['location']; ?></td>  
      <td>
      <a href="<?= base_url('Partner/etrain?id=')?><?= $row['id']; ?>" class="badge badge-success">edit</a>
      <a href="<?= base_url('Partner/deleteetrain?id=')?><?= $row['id']; ?>" class="badge badge-danger">delete</a>
      </td>
    </tr>
    <?php endforeach ?>
