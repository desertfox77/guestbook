...
<style>.bootstrap-iso .formden_header h2, .bootstrap-iso .formden_header p, .bootstrap-iso form{font-family: Arial, Helvetica, sans-serif; color: black}.bootstrap-iso form button, .bootstrap-iso form button:hover{color: white !important;} .asteriskField{color: red;}</style>
  ...
  <div id="wrapper">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <?php
            $id = $_GET['id'];
	$leo= $this->db->query("SELECT * FROM trainer WHERE id='$id'"); 
	foreach($leo->result_array() as $d){
		?>
            <div class="row">
          <div class="col-lg-6">
          <?= form_open_multipart('Partner/etrain');?>
              ...
              <img src="<?= base_url('assets/img/') . $d['image']; ?>" class="img-thumbnail">
      </div>
    ...
    <label for="trainer_name" >Trainer Name</label>
      <input type="label" class="form-control" id="trainer_name" name="trainer_name" value="<?= $d['name']; ?>">
      <?= form_error('trainer_name', '<small class="text-danger pl-3">', '</small>'); ?>
    </div>
    <div class="form-group">
    <label for="trainer_price" >Trainer Price</label>
      <input type="label" class="form-control" id="trainer_price" name="trainer_price" value="<?= $d['price']; ?>">
      <?= form_error('trainer_price', '<small class="text-danger pl-3">', '</small>'); ?>
    </div>
    <select name="sessions" id="wgtmsr" style="width: 500px;" required>
      <option value="">How Much Sessions</option>
    
		  <option value="1sessions">1 Sessions</option>
		  <option value="5sessions">5 Sessions</option>
		  <option value="10sessions">10 Session</option>
      <option value="20sessions">20 Sessions</option>
