      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <div class="row">
          <div class="col-lg-6">
              <form action="<?= base_url('Partner/add')?>" method="post">
              <?= $this->session->flashdata('message'); ?>
              <div class="form-group">
    <label for="shop_name" >Shop Name</label>
      <input type="label" class="form-control" id="shop_name" name="shop_name">
      <?= form_error('shop_name', '<small class="text-danger pl-3">', '</small>'); ?>
    </div>
    <div class="form-group">
    <label for="shop_location" >Shop Location</label>
      <input type="label" class="form-control" id="shop_location" name="shop_location">
