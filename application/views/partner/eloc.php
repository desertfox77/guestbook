...
<style>.bootstrap-iso .formden_header h2, .bootstrap-iso .formden_header p, .bootstrap-iso form{font-family: Arial, Helvetica, sans-serif; color: black}.bootstrap-iso form button, .bootstrap-iso form button:hover{color: white !important;} .asteriskField{color: red;}</style>
  ...
  <div id="wrapper">
	...
	$id = $_GET['id'];
	$hasil = $this->db->query("SELECT * FROM addlocation WHERE id='$id'"); 
	foreach($hasil->result_array() as $d){
		?>
           <div class="modal-body">
       <form action="<?= base_url('Partner/eloc')?>" method="post">
             
              <div class="form-group">
              <input type="hidden" name="id" value="<?php echo $d['id']; ?>">
    <label for="shop_name" >Shop Name</label>
      <input type="label" class="form-control" id="shop_name" name="shop_name"value="<?php echo $d['shop_name']; ?>" required>
      <?= form_error('shop_name', '<small class="text-danger pl-3">', '</small>'); ?>
    </div>
    <div class="form-group">
    <label for="shop_location" >Shop location</label>
      <input type="label" class="form-control" id="shop_location" name="shop_location"value="<?php echo $d['shop_location']; ?>" required>
      <?= form_error('shop_location', '<small class="text-danger pl-3">', '</small>'); ?>
    </div>
    <select name="location" id="wgtmsr" style="width: 300px;" required>
      <option value="">Select Location</option>
    
		  <option value="westbekasi">West Bekasi</option>
		  <option value="eastbekasi">East Bekasi</option>
		  <option value="westbogor">West Bogor</option>
      <option value="eastbogor">East Bogor</option>
      <option value="depok">Depok</option>
      <option value="tangerang">Tangerang</option>
      <option value="southtangerang">South Tangerang</option>
		  <option value="centraljakarta">Central Jakarta</option>
		  
		  <option value="westjakarta">West Jakarta</option>
		  <option value="eastjakarta">East Jakarta</option>
		  <option value="southjakarta">South Jakarta</option>
      <option value="northjakarta">North Jakarta</option>
      </select>
    <br>
    <br>
